...
class HomeController extends Controller
{
    public function homeAction()
    {
        ...
        $get_video_properties_form_ajax = $this->createCustomForm(
        'HomeBundle\Form\TaskType', $taskEntity, 'POST', 'get_video_properties_form');
        ...
        return $this->render('@Home/home/home.html.twig', array(
            ...
            'get_video_properties_form_ajax' => $get_video_properties_form_ajax->createView(),
